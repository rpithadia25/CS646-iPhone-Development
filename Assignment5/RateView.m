...
- (void)baseInit {
    _notSelectedImage = [UIImage imageNamed:@"Star-Empty.png"];
    _halfSelectedImage = [UIImage imageNamed:@"Star-Half.png"];
    _fullSelectedImage = [UIImage imageNamed:@"Star-Full.png"];
    _rating = 0;
    _editable = NO;
